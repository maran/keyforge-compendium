Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "kfwebsite_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = { host: 'keyforge-compendium.com', protocol: 'https' }
  ...
  config.action_mailer.mailgun_settings = {
    ...
    domain: 'mailer.keyforge-compendium.com'
  }
